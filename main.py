...
def run(args):
    ...
    # dataset loader
    train_loader = dataloader.explict_augmentation_loader(
        args) if args.augtype == "explicit" else dataloader.virtual_augmentation_loader(args)
...
def get_args(argv):
    ...
    parser.add_argument('--gpuid', nargs="+", type=int, default=[2],
    ...
    parser.add_argument('--bert', type=str, default="chinese_rbt3_pytorch", help="")
    ...
    parser.add_argument('--dataname', type=str, default='trans_origin', help="")
