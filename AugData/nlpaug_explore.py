...
def contextual_augment(data_source, data_target, textcol="text", aug_p=0.2, device1="cuda", device2="cuda"):
    ...
    augmenter1 = naw.ContextualWordEmbsAug(
        model_type="bert",
        model_path='/home/ctr/ctr_pan/koi2000/sccl/chinese_rbt3_pytorch/', action="substitute", aug_min=1, aug_p=aug_p, device=device1)

    augmenter2 = naw.ContextualWordEmbsAug(
        model_type="bert",
        model_path='/home/ctr/ctr_pan/koi2000/sccl/chinese_rbt3_pytorch/', action="substitute", aug_min=1, aug_p=aug_p, device=device2)
...
def augment_files(datadir="./", targetdir="./", dataset="wiki1m_unique", aug_p=0.1, augtype="trans_subst"):
    ...
    if augtype == "word_deletion":
        ...
        augseq = contextual_augment(DataSource, DataTarget, textcol="text", aug_p=aug_p, device1=device1,
                                    device2=device2)
